...
public:
	void Setup(wxWindow *parent) {
		...
		wxStaticText *statictext_0 = new wxStaticText(parent, wxID_ANY, "Serial", wxDefaultPosition, wxDefaultSize, 0);
		flexgridsizer_0->Add(statictext_0, 0, wxALL, 4);
		serial = new wxTextCtrl(parent, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
		flexgridsizer_0->Add(serial, 0, wxALL|wxEXPAND, 4);
